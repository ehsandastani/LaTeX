...
<p align="justify">
The <b>{class}</b> part at the beginning (\documentclass[options]{class}) indicates the type of document you're working on. For example, you might want to write an article, a book, a report, or even a letter (!) and so on.
</p>
